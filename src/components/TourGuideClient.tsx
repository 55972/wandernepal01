                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-kaleo-terracotta">{guide.specialty}</p>
                      </div>
                    ...
                    <p className="text-sm text-kaleo-charcoal/70 mb-4">{guide.description}</p>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {guide.certifications.map((c: string) => <Badge key={c} variant="outline" className="border-kaleo-terracotta/30 text-kaleo-terracotta text-xs">{c}</Badge>)}
                    </div>
                    <Button onClick={() => setSelectedGuide(guide.id)} className="bg-kaleo-terracotta hover:bg-kaleo-charcoal text-white text-sm w-full">
                      <Send className="w-3 h-3 mr-1" />Book This Guide
                    </Button>
                  </div>
                </div>
              </div>
                ...
                <div className="border-t border-kaleo-terracotta/10 p-6 bg-kaleo-sand/50">
                  ...
                  <form onSubmit={handleContact} className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-kaleo-terracotta flex-shrink-0" />
                    ...
                    <div className="flex gap-3 text-sm text-kaleo-charcoal/60">
                      <a href={`mailto:${guide.contact.email}`} className="flex items-center gap-1 hover:text-kaleo-terracotta"><Mail className="w-3 h-3" />{guide.contact.email}</a>
                      <a href={`tel:${guide.contact.phone}`} className="flex items-center gap-1 hover:text-kaleo-terracotta"><Phone className="w-3 h-3" />{guide.contact.phone}</a>
                    </div>
                  </form>
                </div>
              )}
